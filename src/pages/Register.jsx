...
function Register() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(1200px_circle_at_20%_10%,rgba(16,185,129,0.18),transparent_45%),radial-gradient(900px_circle_at_90%_0%,rgba(14,165,233,0.12),transparent_40%)] py-12 px-4">
      <div className="mx-auto flex w-full max-w-md flex-col justify-center">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-slate-600">Join us in keeping the city clean</p>
        </div>
